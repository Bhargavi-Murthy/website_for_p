...
st.markdown(
    ...
    <style>
        ...
        body {
            ...
            background-image: url('https://raw.githubusercontent.com/Bhargavi-Murthy/website_for_p/main/Screenshot_2019-05-08-00-18-47-705_com.whatsapp%20(1).png'); /* Specify the image path */
